...
namespace Microsoft.MixedReality.WorldLocking.Core
{
    ...
    public class SpongyAnchorARF : SpongyAnchor
    {
...
#if WLT_ARFOUNDATION_PRESENT
        private ARAnchor arReferencePoint = null;
#endif // WLT_ARFOUNDATION_PRESENT
        ...
        {
#if WLT_ARFOUNDATION_PRESENT
            arReferencePoint = GetComponent<ARAnchor>();
#endif // WLT_ARFOUNDATION_PRESENT
            lastNotLocatedTime = Time.unscaledTime;
        }

#if WLT_ARFOUNDATION_PRESENT
        public void Cleanup(ARAnchorManager arReferencePointManager)
        {
            if ((arReferencePointManager != null) && (arReferencePoint != null))
            {
                arReferencePointManager.RemoveAnchor(arReferencePoint);
