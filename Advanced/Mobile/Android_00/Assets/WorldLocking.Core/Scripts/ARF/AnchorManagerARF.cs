...
namespace Microsoft.MixedReality.WorldLocking.Core
{
    ...
    public class AnchorManagerARF : AnchorManager
    {
        ...
        private readonly ARAnchorManager arReferencePointManager;
            ...
            : base(plugin, headTracker)
        {
            ...
            this.arReferencePointManager = arSessionOrigin.gameObject.GetComponent<ARAnchorManager>();
            if (this.arReferencePointManager == null)
            {
                Debug.Log($"Adding AR reference point manager to {arSessionOrigin.name}");
                this.arReferencePointManager = arSessionOrigin.gameObject.AddComponent<ARAnchorManager>();
            }
        ...
        protected override SpongyAnchor CreateAnchor(AnchorId id, Transform parent, Pose initialPose)
        {
            ...
            var referencePoint = arReferencePointManager.AddAnchor(initialPose);
