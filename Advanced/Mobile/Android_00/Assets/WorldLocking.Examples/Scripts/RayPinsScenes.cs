...
{
    public class RayPinsScenes : InputSystemGlobalHandlerListener, IMixedRealityPointerHandler
    {
        /// <summary>
        ...
        static readonly string[] sceneNames = { "RayPinsScene_0", "RayPinsScene_1" };
        ...
        private IEnumerator LoadNextScene()
        {
            ...
            var asyncLoad = SceneManager.LoadSceneAsync(sceneNames[currentSceneIndex], LoadSceneMode.Single);
