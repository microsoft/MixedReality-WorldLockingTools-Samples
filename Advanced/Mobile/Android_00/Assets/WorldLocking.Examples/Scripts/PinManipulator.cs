...
#region Manipulation callbacks
        ...
        private void SetupManipulation()
        {
            ...
            /// The following is redundant (default setting is None) and currently causes an exception:
            /// See https://github.com/microsoft/MixedRealityToolkit-Unity/issues/7463
