...
namespace Microsoft.MixedReality.WorldLocking.Samples
{
    ...
    public class SpacePinQRGroup : MonoBehaviour
    {
        /// <summary>
        ...
        private class SpacePinPackage
        {
            ...
            /// </remarks>
            public static SpacePinPackage Create(SpacePinQRGroup owner, Transform virtualObject)
            {
            ...
            /// <summary>
            /// Determine whether the pose should be committed to the space pin system.
            /// </summary>
            /// <param name="lockedPose">The pose to test, in locked space.</param>
            /// <returns>True if a commit is indicated.</returns>
        ...
        /// <summary>
        /// The mini manager will issue qr event notifications from the main thread.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// After calling this, the group is no longer usable.
        /// </remarks>
        ...
        /// <summary>
        /// Release resources in preparation for destruction. Cannot be revived.
        /// </summary>
